...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="../css icons/my-slide.css">
        <title>Laravel</title>
    ...
    <body>
        ...
        <div class="grid">
            <section class="header">
                <div class="row search mx-0 align-items-center">
                    ...
                    @endif
                        {{-- <a href="#"data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <button><i class="fa-solid fa-circle-user pt-2"></i></button>
                ...
                <div class="row meun d-flex align-items-center justify-content-between mx-0">
                    ...
                    <div class="col-3 col-lg-4 px-0">
                        <ul class="navbar m-0">
                            <li><a href="ecomerce-plant-store.html">Home</a></li>
            ...
            <div class="main-content">
                <div class="fixed-bg-shop img-bg-5">
                    <div class="title-1">                   
                        #stayhome
                    </div>
                    <div class="title-2">
                    ...
                    <div class="modal-body">
                        <form action="/">
                            <div class="input-group m-0">
                                <input class="log-in" id="login" placeholder="Your email address" aria-label="SIGN IN">  
                                <button class="btn m-0" data-bs-dismiss="modal">Log In</button>
                            </div>
                        </form>
                    </div>
                </div>
